...
TIM_HandleTypeDef htim2;
 uint32_t frequencyHz; // Hz cinsinden frekansi temsil edecek deger
 float frequencyMHZ;

 uint32_t realfrequencyHz; // Hz cinsinden frekansi temsil edecek deger
  float realfrequencyMHZ;
